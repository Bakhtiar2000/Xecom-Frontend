...
import { useGetAllWishlistsQuery, useRemoveFromWishlistMutation } from "@/redux/features/product/wishlist.api";
                    ...
                    return (
                        ...
                        >
                            ...
                            <button
                                ...
                                disabled={isRemoving}
                                className="absolute top-4 cursor-pointer right-4 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white/90 shadow backdrop-blur-sm transition hover:bg-red-50 hover:text-red-500 disabled:opacity-50"
                            >
