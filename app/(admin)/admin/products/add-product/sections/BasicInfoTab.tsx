        ...
        <CardContent className="space-y-4">
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    {...field}
                    onChange={(e) => { field.onChange(e); onNameChange(e.target.value); }}
                  />
                </FormControl>
          ...
          <FormField control={form.control} name="fullDescription" render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  ref={(el) => { fieldRefs.current["fullDescription"] = el; }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField control={form.control} name="brandId" render={({ field }) => (
              <FormItem  >
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  <FormControl>
                    <SelectTrigger className="w-full" ref={(el) => { fieldRefs.current["brandId"] = el; }}>
            ...
            <FormField control={form.control} name="categoryId" render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  <FormControl>
                    <SelectTrigger className="w-full" ref={(el) => { fieldRefs.current["categoryId"] = el; }}>
                      <SelectValue placeholder="Select a category" />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
                    <SelectItem value="9bd04cc8-354a-4c6d-8d44-dd1d9a720eba">Men&apos;s Shoe</SelectItem>
