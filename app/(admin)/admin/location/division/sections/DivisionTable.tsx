...
const buildQueryParams = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.success(
        result?.message || "Division deleted successfully"
      );
        ...
        <div
          className={`max-w-64 min-w-44 ${
            selectedCountry?.length
              ? "[&_button]:border-primary [&_button]:bg-primary/5"
              : ""
          }`}
        >
          <CustomSelect
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete division "
