...
export default function OrderItemPageRenderer({
    ...
    if (orders.length === 0) {
        return <p className="text-muted-foreground py-10 text-center">No orders found for this status.</p>;
    }
            ...
            <aside className="border-border max-h-[75vh] overflow-y-auto rounded-lg border">
                ...
                {orders.map((order: TOrderWithRelations) => (
                    <div
                        ...
                        className={`cursor-pointer border-b p-3 transition-colors ${selectedOrder?.id === order.id
                    ...
                    >
                        ...
                        <div className="mt-2 flex items-center justify-between gap-2">
                            ...
                            <div className="text-right text-sm">
                                ...
                                <p className="text-muted-foreground text-xs">{order.orderItems?.length || 0} items</p>
                            </div>
                        </div>
                    </div>
                ))}
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 gap-5 text-sm md:grid-cols-2">
                            <div>
                                ...
                                <p>
                                    <span className="font-semibold">Total:</span> ${Number(selectedOrder.total || 0).toFixed(2)}
                                </p>
                                <p>
                                    <span className="font-semibold">Tracking:</span> {selectedOrder.trackingNumber || "Not assigned"}
                                </p>
                            </div>

                            <div>
                                <p>
                                    <span className="font-semibold">Address:</span> {selectedOrder.address?.street || "N/A"}
                                </p>
                                <p>
                                    <span className="font-semibold">Thana:</span> {selectedOrder.address?.thana?.name || "N/A"}
                                </p>
                                <p>
