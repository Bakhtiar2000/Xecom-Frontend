                            ...
                            <div key={order.id} className="flex justify-between items-center p-4 border rounded-lg">
                                ...
                                <div className="text-right">
                                    ...
                                    <span className={`text-xs px-2 py-1 rounded-full ${order.status === 'Delivered' ? 'bg-accent text-success' :
                                        order.status === 'Shipped' ? 'bg-accent text-info' :
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <Card className="bg-background rounded-lg shadow-md border border-border hover:shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer">
                    <CardContent className="p-4 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">Create and publish a new product</p>
                ...
                <Card className="bg-background rounded-lg shadow-md border border-border hover:shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer">
                    <CardContent className="p-4 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">View and process customer orders</p>
                        <Link href="/admin/orders">
                ...
                <Card className="bg-background rounded-lg shadow-md border border-border hover:shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer">
                    <CardContent className="p-4 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">View and manage customer accounts</p>
                ...
                <Card className="bg-background rounded-lg shadow-md border border-border hover:shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer">
                    <CardContent className="p-4 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">Check sales reports and analytics</p>
                ...
                <Card className="bg-background rounded-lg shadow-md border border-border hover:shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer">
                    <CardContent className="p-4 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">Organize product categories</p>
                ...
                <Card className="bg-background rounded-lg shadow-md border border-border hover:shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer">
                    <CardContent className="p-4 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">Configure store settings</p>
