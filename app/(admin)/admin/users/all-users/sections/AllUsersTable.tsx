    ...
    <>
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-4 lg:flex-row lg:justify-end">
          ...
          >
            <SelectTrigger className={gender ? "border-primary bg-primary/5" : ""}>
          ...
          >
            <SelectTrigger className={status ? "border-primary bg-primary/5" : ""}>
          ...
          >
            <SelectTrigger className={role ? "border-primary bg-primary/5" : ""}>
      ...
      {/* Table */}
      <div className="border-border relative mt-4 rounded-md border">
