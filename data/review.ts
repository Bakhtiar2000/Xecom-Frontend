...
export const reviews = [
  {
    ...
    time: "5 weeks ago",
    comment:
      "The sneakers are very comfortable and lightweight, perfect for daily wear. The sizing runs slightly small.",
  },
  {
    name: "Yansim",
    avatar: "/man2.png",
    ...
    time: "1 weeks ago",
    comment:
      "Exceeded my expectations. The materials feel premium and the packaging was excellent.",
  },
  {
    name: "Rafyzju",
    avatar: "/man3.png",
