...
export default function Hero_Section() {
  ...
  return (
    <section className="container">
      ...
      {/* MAIN CONTENT */}
      <div className="flex flex-col lg:flex-row justify-between items-center lg:px-12 gap-10 sm:gap-16">
        {/* RIGHT SIDE IMAGE + TAGS */}
        <div className="relative z-10 w-full max-w-150 lg:w-1/2 h-[30vh] lg:h-[60vh] mx-auto flex items-center justify-center">
        ...
        <div className="w-full lg:w-1/2 relative z-10">
          <div className="bg-primary rounded-xl border px-6 py-4 flex flex-col justify-between items-start gap-8 shadow-lg">
            <div className="w-full space-y-2">
              ...
              >
                <div className="flex text-primary-foreground items-baseline gap-3 mb-4">
              ...
              <div className="space-y-4 text-primary-foreground">
                ...
                <button className="uppercase cursor-pointer text-xs font-medium  transition-colors duration-200 flex items-center gap-1 group">
                  Discover More
            ...
            <div className="hidden lg:flex text-primary-foreground items-center justify-end gap-4 text-lg w-full border-t border-opacity-20 pt-2">
              <div className="flex gap-2">
                <button className="group relative p-2 cursor-pointer rounded-xl  backdrop-blur-sm transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,100,50,0.5)] hover:scale-105 shadow-lg">
                ...
                <button className="group relative p-2 cursor-pointer rounded-xl  backdrop-blur-sm hover:shadow-[0_0_20px_rgba(255,100,50,0.5)] transition-all duration-300 hover:scale-105 shadow-lg">
