                            ...
                            <div className=" rounded-xl border  px-6 sm:px-8 py-5 flex flex-col justify-between items-start gap-8 lg:-mr-12  shadow-lg">
                                ...
                                <div className="flex items-center gap-3  text-lg w-full justify-between border-t border-opacity-20 pt-4">
                                    ...
                                    <div className="flex gap-2">
                                        <button className="group relative p-3 rounded-xl  backdrop-blur-sm   transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,100,50,0.5)] hover:scale-105 shadow-lg ">
                                        ...
                                        <button className="group relative p-3 rounded-xl  backdrop-blur-sm  hover:shadow-[0_0_20px_rgba(255,100,50,0.5)] transition-all duration-300  hover:scale-105 shadow-lg ">
                                            <Shuffle className="w-5 h-5   transition-colors duration-300" />
                                            <div className="absolute inset-0 rounded-xl  to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 -skew-x-12"></div>
                                        </button>
                                        <button className="group relative p-3 rounded-xl  backdrop-blur-sm   transition-all duration-300  hover:scale-105 shadow-lg ">
