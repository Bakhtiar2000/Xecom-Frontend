        ...
        <>
            <section className="relative max-w-11/12 mx-auto px-4  pt-20 lg:pt-2 pb-20 ">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-sm uppercase tracking-wider mb-2 merriweather-font"> Explore our curated collection through stunning visuals</p>
                                ...
                                <div className="absolute bottom-0 left-0 right-0  transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                                    <div className=" backdrop-blur-sm  px-4 py-8">
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <span className="text-xs ">{item.likes + (likedImages.includes(item.id) ? 1 : 0)} likes</span>
                                        </div>
                                        <h3 className="text-sm font-semibold  line-clamp-1">{item.alt}</h3>
