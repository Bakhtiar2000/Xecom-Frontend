...
export default function MegaWinterSell() {
  ...
  return (
    <section className="w-11/12 mx-auto lg:mb-20 mb-5 rounded-2xl min-h-screen relative overflow-hidden mega-sale-bg text-white  poppins-font">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          >
            ...
            >
              ...
              on premium footwear collection. Limited time offer on all running,
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg- px-8 py-4 rounded-full bg-button-secondary font-bold shadow-2xl flex items-center gap-3 group"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="border-2 border-white/30  px-8 py-4 rounded-full font-bold backdrop-blur-sm hover:bg-white/10 transition-all"
              >
                View Deals
              </motion.button>
            </motion.div>
