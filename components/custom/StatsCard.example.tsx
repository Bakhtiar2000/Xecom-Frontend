...
export function BasicStatsCards() {
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
      <StatsCard title="Total Users" value={1234} icon={Users} colorVariant="blue" />
      <StatsCard title="Total Orders" value={856} icon={ShoppingCart} colorVariant="green" />
      <StatsCard title="Revenue" value={45678} icon={DollarSign} colorVariant="purple" />
      <StatsCard title="Growth" value={23} icon={TrendingUp} colorVariant="orange" />
    </div>
  );
}
...
export function LoadingStatsCards() {
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
      <StatsCard title="Total Users" value={0} icon={Users} colorVariant="blue" isLoading={true} />
      <StatsCard
        title="Active Users"
        value={0}
        icon={Users}
